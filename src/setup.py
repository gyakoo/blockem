...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "blockem.py"
 
        #Name of program
        self.project_name = "Block them"
 
        #Project url
        self.project_url = "http://gyakoo-resume.blogspot.com"
        ...
        #Auhor of program
        self.author_name = "gyakoo - Jose Manuel Marin Roman"
        self.author_email = "gyakoo@gmail.com"
        self.copyright = "Copyright (c) 2010 gyakoo"
 
        #Description
        self.project_description = "Simple game"
